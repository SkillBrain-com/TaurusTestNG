...
public class DemoQaBrowserWindowsPageObject extends BasePageObject {
    ...
    public void getMessageFromNewWindow() {
        ...
        waitForNewWindowToOpen(currentWindowHandle);
        Set<String> allWindowHandles = driver.getWindowHandles();
        ArrayList<String> strings = new ArrayList<>(allWindowHandles);
        driver.switchTo().newWindow(WindowType.WINDOW);
        String actualHeadingText = textFromNewWindow.getText();
        Assert.assertEquals(actualHeadingText,"Knowledge increases by sharing but not by saving. Please share this website with your friends and in your organization.");
        //System.out.println("Heading from new window: " + sampleHeading.getText());
    }

    public void clickOnNewWindowMessageButton() {
        JavascriptExecutor js = (JavascriptExecutor)driver;
        js.executeScript("arguments[0].scrollIntoView(true);", newWindowMessageButton);
